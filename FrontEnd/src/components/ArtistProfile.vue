...
<template>
    <div class="artist-page-view">
        <div class="h-124 rounded-4xl bg-[position:center_40%] mt-5 ml-5 ss mr-5 flex flex-col justify-end pb-6"
            ...
            <p class="text-white font-medium text-left pl-7">
                ...
                <button
                    ...
                    class="font-bold rounded-full px-6 py-2 w-32 mt-4 ml-3 border-2 transition-all duration-200 hover:cursor-pointer"
                    :class="isFollowing 
                    ? 'bg-green-500 text-white border-green-500 w-42 hover:bg-green-600 hover:border-green-600' 
